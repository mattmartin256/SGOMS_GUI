...
Version 1.2 allows for editing the contents of nodes, and saving/loading models from a file.
...
class SGOMSDialogPanel(JPanel):
    ...
    def __init__(self, theSGOMSUnit):
        ...
        self.nameEntry = JTextField(nameVar, 30)    ## Default column width = 30 char
        ...
        for x in range(1, 6):
            ...
            firingConditionEntry = JTextField(firingConditionVar, 30)
        ...
        for x in range(1, 6):
            ...
            behaviourEntry = JTextField(behaviourVar, 30)
...
class GraphEditorPanel(JPanel, MouseListener, MouseMotionListener, KeyListener):
        ...
        if (event.getClickCount() == 2):
            ...
            if aNode == None:   ##If there was no node, check to see if it was an edge
                ...
                if anEdge == None: ##If no edge and no node clicked, create a new node
                    ...
                    if self.graph.selectedSGOMSType == "PLANNING_UNIT":
    ...
    def mousePressed(self, event):
        ...
        aNode = self.graph.nodeAt(event.getPoint())     ## Returns none by default
        ...
        ##If the click was in an edge (i.e. not in a node), store the dragEdge variables
            ...
            self.dragEdge = self.graph.edgeAt(event.getPoint()) ## Returns None by default
...
class GraphEditorFrameButtonPanel(JPanel):
    ...
    def planningUnitButtonSelected(self, event):
        ...
        self.graph.selectedSGOMSType = "PLANNING_UNIT"
        
        print "(ButtonPanel.planningUnitButtonSelected) selectedSGOMSType = ", self.graph.selectedSGOMSType
    ...
    def unitTaskButtonSelected(self, event):
        ...
        self.graph.selectedSGOMSType = "UNIT_TASK"
        
        print "(ButtonPanel.unitTaskButtonSelected) selectedSGOMSType = ", self.graph.selectedSGOMSType
    ...
    def methodButtonSelected(self, event):
        ...
        self.graph.selectedSGOMSType = "METHOD"
        
        print "(ButtonPanel.methodButtonSelected) selectedSGOMSType = ", self.graph.selectedSGOMSType
    ...
    def operatorButtonSelected(self, event):
        ...
        self.graph.selectedSGOMSType = "OPERATOR"
        
        print "(ButtonPanel.operatorButtonSelected) selectedSGOMSType = ", self.graph.selectedSGOMSType
